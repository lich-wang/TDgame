...
- 将玩家建筑、敌方船舶/飞机/登陆兵、弹头/无人机/水雷全部改为 PNG spritesheet 绘制。
- 将可放置塔位、水雷槽位和敌方航道重配到 `battlefield-hormuz.png` 的视觉平台和发光水道上。
...
- 岸防平台从左到右分布在画面上方海岸线，塔位使用 8 个坐标：
  `(65,172)`, `(175,154)`, `(290,139)`, `(405,128)`, `(520,118)`, `(635,109)`, `(750,104)`, `(865,104)`。
- 敌方主航道沿中部发光水道从右上到左下：
